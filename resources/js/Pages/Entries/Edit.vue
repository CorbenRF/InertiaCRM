...
<template>
  ...
  export default {
    ...
    props: ['id', 'readOnlyDefault', 'entry'],
    data() {
      return {
        entryData: '',
      ...
      organiseData(obj) {
        ...
        if (!isObjectEmpty(obj)) {
          ...
          newObj = {
            ...
            client: {
              id: obj.client_name_id,
              name: obj.clientName,
            },
            vendor: {
              id: obj.vendor_name_id,
              name: obj.vendorName,
            },
            subvendor: {
              id: obj.subvendor_name_id,
              name: obj.subvendorName,
            },
            status: {
              id: obj.status_id,
              name: obj.statusName,
            ...
            curator: {
              id: obj.curator_id,
              name: obj.curatorName,
              department_id: obj.curatorDeptId,
            },
            inspector: {
              id: obj.inspector_id,
              name: obj.inspectorName,
